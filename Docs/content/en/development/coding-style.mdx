...
- avoid em dashes.
- end complete sentences in paragraphs, list items, summaries, parameters, returns, and exception descriptions with a period.
...
Public methods must include the following.
