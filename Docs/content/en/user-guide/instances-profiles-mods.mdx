...
To install several mods together, select the compatible catalog entries and select **Install** in the top bar. The **Preview** sheet shows the selected mods and their required dependencies before installation. Review the versions, then select **Install** to continue. The catalog shows installation progress until the selected mods finish.
